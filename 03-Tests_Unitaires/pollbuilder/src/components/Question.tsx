...
export const Question: React.FC<{
    ...
    return (
        <form className="w-full max-w-sm">
            <input placeholder="Saisir la question" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700" type="text" value={question.title} onChange={(e) => onChange(question.id, e.target.value)} />
            ...
            <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-gray-500" onClick={() => addAnswer(question.id)}>Ajouter une réponse</button>
        </form>
    )
}